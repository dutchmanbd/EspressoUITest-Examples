...
class GalleryActivityTest{
    ...
    fun testValidateGalleryIntent() {
        ...
        val activityResult = createGalleryPickupActivityResultStub()
        intending(expectedIntent).respondWith(activityResult)

        // Execute and Verify
        onView(withId(R.id.btnPickupImage)).perform(click())
        intended(expectedIntent)
    }

    private fun createGalleryPickupActivityResultStub(): ActivityResult{
